...
public class PostCardRecyclerViewAdapter extends RecyclerView.Adapter<PostCardRecyclerViewAdapter.ViewHolder> {
    ...
    public PostCardRecyclerViewAdapter(Context parentActivityContext) {
        this.parentActivityContext = parentActivityContext;
    }

    public PostCardRecyclerViewAdapter(Context parentActivityContext, ArrayList<Post> posts) {
        this.parentActivityContext = parentActivityContext;
        this.posts = posts;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_post_card, parent, false);
    ...
    public void appendPosts(ArrayList<Post> posts) {
